...
#' Please refer to the parameter 'tau' in survRM2 package: [rmst2](https://rdrr.io/cran/survRM2/man/rmst2.html) function
...
#' When \code{power} is not given, the function finds the critical values that control the overall type I error < alpha
...
#' @param mu_cov_h0 Variance-covariance matrix of (E1-C1, E1, E2-C2, E2) under the null hypothesis (H0), obtained from the \code{mu_cov_mc} function.
#' @param mu_cov_h1 Variance-covariance matrix of (E1-C1, E1, E2-C2, E2) under the alternative hypothesis (H1), obtained from the \code{mu_cov_mc} function.
...
#' @param method Method used for the RMST design. "Simple" indicates a Simple RMST with the rejection region (D1 > m1 & D2 > m2), where D = E - C is the RMST difference between groups. "Complex" indicates a Sculpted RMST with the rejection region (D1 > m1 & E1 > q1 & D2 > m2 & E2 > q2), where E is the RMST in the experimental group.
#' @param alpha Stated type I error level.
