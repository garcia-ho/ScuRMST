...
#' @importFrom nph some_nph_function
#' @importFrom tidyverse some_tidyverse_function
#' @importFrom foreach %dopar% foreach
#' @importFrom doParallel registerDoParallel
#' @importFrom cowplot plot_grid
#' @importFrom IRdisplay display
#' @importFrom rlang some_rlang_function
#' @importFrom simtrial some_simtrial_function
...
#' @param n: Sample size in one arm
...
#' @param tau: Cut-off time for RMST(used for final stage)
#' 
...
#' @param  acc_time: Accrual time period with constant rate
#' @param  cen_time: Extra (minimum) censoring period after accrual period
#' @param  lambda_H0: The parameter lambda of exponential distribution under H0
#' @param  lambda_H1: The parameter lambda of exponential distribution in experiment group under H1
#' 
...
#' log_rank_sim 
#' --------------------------------
#' For log rank test simulation. 
#' Return the simulated type I error, empirical mean and variance of Z-statistics 
#' @param data_E: Survival data of experiment group generated by expo_gen_2stages
#' @param data_C: Survival data of control group generated by expo_gen_2stages
#' @param sim_size: simulation times
#' @param n: Sample size in one arm
...
#'   \item{var_w}{The variance of W for correlation.}
#' }
#' @examples
#' result <- log_rank_sim(data_C=data_C, data_E=data_C, sim_size = 10000, n = 50, alpha = 0.05, sided = 'one-sided' )
#' print(result$rejection)
#' print(result$z_stats)
#' print(result$var_w)
#' @export
#' 
...
#' PET_norm
#' ------------------------------
#' It returns c(PET0, PET1), where PET0 = prob(E-C>m1 & E>t1|H0). Use bivariate normal density to calculate.
#' Input the estimated RMST mean and variance of each group (control and experiment) and the critical value
...
#'
#' @param rmst_int: A matrix of interim RMST data for two groups with rows representing the groups and columns representing the simulations.
#' @param rmst_fin: A matrix of final RMST data for two groups with rows representing the groups and columns representing the simulations.
